...
/**
 * Provides the local service interface for GalleryVisit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author James Falkner
 * @see GalleryVisitLocalServiceUtil
...
public interface GalleryVisitLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link GalleryVisitLocalServiceUtil} to access the gallery visit local service. Add custom service methods to {@link com.liferay.museum.service.impl.GalleryVisitLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
